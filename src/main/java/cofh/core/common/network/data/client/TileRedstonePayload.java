...
public record TileRedstonePayload(BlockPos pos, FriendlyByteBuf buf) implements CustomPacketPayload {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ID_COFH_CORE, "tile_redstone_packet");

    public TileRedstonePayload(final FriendlyByteBuf buf) {
